...
def get_accounts(account_id):
    """
    Reads an Account
    This endpoint will read an Account based on the account_id in the path
    """
...
def update_accounts(account_id):
    """
    Updates an Account
    This endpoint will update an Account based on the account_id in the path
    """
...
def delete_accounts(account_id):
    """
    Deletes an Account
    This endpoint will delete an Account based on the account_id in the path
    """
